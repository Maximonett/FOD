...
procedure minimo(var det1, det2, det3:detalle; var info1,info2,info3:infoDetalle;var min:infoDetalle);
begin 
...
begin
		...
		while (min.codigo<>VA) do begin
			...
			infoMae.cant:=0;
			while (infoMae.codigo=min.codigo) do begin
...
begin
	...
	while (not eof(mae)) do begin
		read(mae,i);
		writeln('Codigo: ',i.codigo,' Nombre: ',i.nombre,'Cantidad: ',i.cant);
	end;
	close(mae);
end;
